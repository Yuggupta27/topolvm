...
var file_lvmd_proto_lvmd_proto_rawDesc = []byte{
	...
	0x32, 0xac, 0x01, 0x0a, 0x09, 0x4c, 0x56, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3b,
...
var file_lvmd_proto_lvmd_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_lvmd_proto_lvmd_proto_goTypes = []interface{}{
	...
	(*ThinPoolItem)(nil),         // 11: proto.ThinPoolItem
	(*WatchItem)(nil),            // 12: proto.WatchItem
}
var file_lvmd_proto_lvmd_proto_depIdxs = []int32{
	...
	12, // 2: proto.WatchResponse.items:type_name -> proto.WatchItem
	11, // 3: proto.WatchItem.thin_pool:type_name -> proto.ThinPoolItem
	...
	5,  // 6: proto.LVService.ResizeLV:input_type -> proto.ResizeLVRequest
	8,  // 7: proto.VGService.GetLVList:input_type -> proto.GetLVListRequest
	9,  // 8: proto.VGService.GetFreeBytes:input_type -> proto.GetFreeBytesRequest
	0,  // 9: proto.VGService.Watch:input_type -> proto.Empty
	3,  // 10: proto.LVService.CreateLV:output_type -> proto.CreateLVResponse
	0,  // 11: proto.LVService.RemoveLV:output_type -> proto.Empty
	0,  // 12: proto.LVService.ResizeLV:output_type -> proto.Empty
	6,  // 13: proto.VGService.GetLVList:output_type -> proto.GetLVListResponse
	7,  // 14: proto.VGService.GetFreeBytes:output_type -> proto.GetFreeBytesResponse
	10, // 15: proto.VGService.Watch:output_type -> proto.WatchResponse
